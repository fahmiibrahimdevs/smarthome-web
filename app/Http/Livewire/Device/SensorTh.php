...
class SensorTh extends Component
{
    use LivewireAlert;
    use WithPagination;
    ...
    public function render()
    {
        ...
        return view('livewire.device.sensor-th', compact('data', 'rooms', 'features'))
            ->extends('layouts.apps', ['title' => 'Configure Device - SENSOR TH']);
    }
    ...
    public function mount()
    {
        ...
        $this->name_device   = 'TEMPERATURE AND HUMIDITY';
        $this->topic         = '';
        $this->retain        = 'true';
        $this->active        = '';
        $this->inactive      = '';
