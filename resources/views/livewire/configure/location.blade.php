<div>
    <section class="section">
        <div class="section-header tw-rounded-none lg:tw-rounded-lg tw-shadow-md tw-shadow-gray-300 px-4">
            <h1 class="tw-text-lg mb-1">Configure Location</h1>
        </div>
                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                <tr class="text-center">
                                    <td>{{ $loop->index + 1 }}</td>
                                    <td class="text-left">{{ $row->name_location }}</td>
                                    <td>
                ...
                <form>
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input type="text" wire:model="name_location" id="name_location" class="form-control">
                        </div>
                    </div>
