<div>
    <section class="section">
        <div class="section-header tw-rounded-none lg:tw-rounded-lg tw-shadow-md tw-shadow-gray-300 px-4">
            <h1 class="tw-text-lg mb-1">Category</h1>
        </div>
                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                <tr class="text-center">
                                    <td>{{ $loop->index + 1 }}</td>
                                    <td class="text-left">{{ $row->name_category }}</td>
                                    <td>
                                        @if ( $row->name_category == "POWER" || $row->name_category == "KWH MONITORING"
                                        || $row->name_category == "REMOTE" || $row->name_category == "SENSOR TH")
                                        <i>Cannot be edited or deleted, thanks</span>
                                            @else
                                            <button class="btn btn-primary" wire:click='edit({{ $row->id }})'
                ...
                <form>
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input type="text" wire:model="name_category" id="name_category" class="form-control">
                        </div>
                    </div>
